	...
	<div class="maincontent">
		<div class="swiper mySwiper">
			...
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<img src="./template/web/assets/img/baner.jpg" />
				</div>
				<div class="swiper-slide">
					<img src="./template/web/assets/img/baner1.jpg" />
				</div>
				<div class="swiper-slide">
					<img src="./template/web/assets/img/baner2.jpg" />
				</div>
				<div class="swiper-slide">
					<img src="./template/web/assets/img/baner3.jpg" />
				</div>
				<div class="swiper-slide">
					<img src="./template/web/assets/img/baner4.jpg" />
				</div>
			</div>
					...
					<div class="searchform">
						...
						<div class="input">
							...
							<div class="btn-quantity-room">
								<i class="fa-solid fa-hotel"></i> <input type="number" id="room" value="1"
									min="1" max="100" />
							</div>
						</div>
		...
		<div class="aboutus">
			<video autoplay loop muted plays-inline>
				<source src="./template/web/assets/video/aboutus.mp4"
					type="video/mp4" />
			</video>
			<div class="context-about">
				<h2>About us</h2>
				<p>Committed to everyone seeking energy and excitement, we offer
		...
		<div class="hotelpool">
			<div class="hotelpool-sub-container">
				<div class="context-pool">
					...
					<p>The indoor heated pool has vaulted wood beam ceilings. The
						...
						the pool.</p>
					<p>The serene pool at Royal Villas spa resort and hotel boasts
						sleek décor that features striking floor-to-ceiling teak columns
						set against a cool black tile floor. Poolside dining is also
						...
						classes help keep guests fit while on the road.</p>
					<div class="btn_pool">
						<button>Read more</button>
					</div>
				</div>
