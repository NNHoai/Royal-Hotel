...
<div class="infoHotel">
	...
	<hr>
	<form action="/Royal_Hotel/admin/save" method="post">
		<c:forEach var="item" items="${HotelManage }">
			<div class="form-group">
				<p>Name Hotel</p>
				<input type="Text" class="form-control" placeholder="ROYAL HOTEL"
					id="NameHotel" name="nameHotel" value="${item.nameHotel }">
			</div>
			<div class="form-group">
				<p>Address Hotel</p>
				<input type="text" class="form-control" name="addressHotel"
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" placeholder="0789999999"
					id="PhoneHotel" name="phoneHotel" value="${item.phoneHotel }">
			</div>
			<div class="form-group">
				<p>Email Hotel</p>
				<input type="text" class="form-control" name="emailHotel"
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" placeholder="012131415"
					id="FaxHotel" name="faxHotel" value="${item.faxHotel }">
			</div>
